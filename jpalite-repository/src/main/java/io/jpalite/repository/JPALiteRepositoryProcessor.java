...
public class JPALiteRepositoryProcessor extends AbstractProcessor
{
	...
	public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv)
	{
		...
		note("Creating TradeSwitch® JPA Repositories");
		try {
	...
	@SuppressWarnings("java:S3776") //Complexity cannot be reduced further
	...
	private void generateRepo(TypeElement repoElement, Repository annotation) throws IOException
	{
		...
		try (PrintWriter out = new PrintWriter(repoFile.openWriter())) {
			...
			out.println("import io.jpalite.extension.TradeSwitchPersistenceProducer;");
			out.println("import io.jpalite.TradeSwitchEntityManager;");
			...
			//out.println("   EntityManager em  = Arc.container().instance(EntityManager.class).get();");
