...
class JPQLParserTest
{
	...
	void whenOverridingFetchTypes_thenGenerateQueryCorrect() throws JSQLParserException
	{
		...
		vHints.put(JPALiteEntityManager.TRADESWITCH_OVERRIDE_BASIC_FETCHTYPE, FetchType.EAGER);
		...
		vHints = new HashMap<>();
		vHints.put(JPALiteEntityManager.TRADESWITCH_OVERRIDE_FETCHTYPE, FetchType.LAZY);
