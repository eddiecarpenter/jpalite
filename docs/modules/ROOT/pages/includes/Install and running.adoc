...
The Repository implementation is discussed in detail xref:includes/Repository Pattern.adoc[here].
...
See xref:includes/Dependency Injection.adoc[Dependency Injection] for more detail.
