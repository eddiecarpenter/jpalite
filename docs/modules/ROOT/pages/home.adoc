...
Welcome to the JPALite documentation.
The documentation will guide you on how to install, configure and use JPALite.
...
The aim is not to provide a detailed architectural design but rather to provide enough architectural background information to enable you to use the JPALite functionality effectively.
...
Please keep in mind that JPALite does not support all of the JPA functionality, and some of the more advanced features might not be available.

If you get to a point where you need a specific feature not currently supported, speak to the Architecture team!
